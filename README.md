...
## Conclusion/今後の展望
本研究では、複数の滑走記録アプリを同一条件下で比較し、滑走距離や軌跡の精度、および利用者視点での使いやすさについて検証した。その結果、アプリ間で記録精度に差が見られ、特にStravaでは一部の記録においてはラグが確認されたものの、他アプリと比べて精度の高い滑走記録が取得できる一方、一部のアプリではラグが発生する場合があると明らかになった。また、利用者アンケートからは、滑走記録アプリが行動ログの管理や研究・解析目的など、正確性を重視した用途で使用されていることが示された。よって、より精度の高い滑走ログを記録できるアプリは需要があると言える。  
